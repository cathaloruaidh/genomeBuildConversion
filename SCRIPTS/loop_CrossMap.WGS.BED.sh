...
do
	...
	SOURCE_PASS_PREV=${OUT_DIR}/${PREFIX}_CrossMap_${SOURCE}_${p}.pass.bed
	SOURCE_OUT=${OUT_DIR}/${PREFIX}_CrossMap_${SOURCE}_${i}.out.bed
	SOURCE_PASS=${OUT_DIR}/${PREFIX}_CrossMap_${SOURCE}_${i}.pass.bed
	SOURCE_REJECT=${OUT_DIR}/${PREFIX}_CrossMap_${SOURCE}_${i}.reject.bed
	...
	TARGET_OUT=${OUT_DIR}/${PREFIX}_CrossMap_${TARGET}_${i}.out.bed
	TARGET_PASS=${OUT_DIR}/${PREFIX}_CrossMap_${TARGET}_${i}.pass.bed
	TARGET_REJECT=${OUT_DIR}/${PREFIX}_CrossMap_${TARGET}_${i}.reject.bed
